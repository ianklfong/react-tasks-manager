...
export default function Components ({handleToggleForm}){
        ...
        <div className='row d-lg-none px-3 pt-4 fixed-top' style={{alignItems: 'space-between'}}>
            <div className="col mb-3 ms-1">
                <svg type='button' width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleClick}>
                    <path d="M4.46875 6.90625H21.5312M4.46875 19.9062H21.5312H4.46875ZM4.46875 13.4062H21.5312H4.46875Z" stroke="#70bbae" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="#70bbae" />
                </svg>
            </div>
