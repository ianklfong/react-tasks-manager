...
function Task({ deleteToDoItem, task, index, handleEditTask, handleToggleDone, handleRemoveTask }) {
    ...
    // const handleChange = (event) => { setEditTitle(event.target.value) }
    ...
    // const updateDoneStatus = async (id, done) => {
    //     const testDoc = doc(db, "task", id)
    //     let newFields = {done: isDone}
    //     isDone ? newFields = {done: isDone} : newFields = {done: !isDone}
    //     await updateDoc(testDoc, newFields) 
    // }
                ...
                >
                    ...
                    <div className="row">
                        ...
                        <div className="col-1 m-auto">
                            <i type="button"
                                name="done"
                                // onClick={() => { updateDoneStatus(task.id, task.done); setIsDone(isDone) }}
                        ...
                        {edit ?
                            <button
                                ...
                                // onClick={() => { updateToDoItem(task.id, task.title) }}
                            >
