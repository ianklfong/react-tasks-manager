            ...
            <nav>
                ...
                <ul className="mt-lg-5 list-unstyled" style={{marginTop: '7.7rem'}}>
                    ...
                    <li>
                        <a href="#Home">
                            {/* home icon */}
                            <svg className="nav-icon" width="25" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="#Lists">
                            {/* lists icon */}
                            <svg style={{left:7.5}} className="nav-icon"  width="28" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="ms-4 ps-3 my-auto">Lists</p>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#">
                            {/* calendar icon */}
                                <svg className="nav-icon" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="ms-4 ps-3 my-auto">Calendar</p>
                        </a>
                    </li>
                </ul>
